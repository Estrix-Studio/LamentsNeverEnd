...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Torch"",
            ""id"": ""b5f313e9-9b9c-49eb-8544-7af2b3fc1439"",
            ""actions"": [
                {
                    ""name"": ""Toggle"",
                    ""type"": ""Button"",
                    ""id"": ""aa23114f-5ee5-4d37-a381-982b5f7afbec"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Dim"",
                    ""type"": ""Button"",
                    ""id"": ""bb22198c-2afd-4067-9a0e-0fc358e02f0e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Normal"",
                    ""type"": ""Button"",
                    ""id"": ""7d9e928d-886d-42e4-b550-533cf1a2cd8c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""b1ca8e18-a167-4c1c-8f2d-1734ec5c77c3"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""b985123a-ac72-4307-86cd-0e5f3c2c725f"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""63da51b8-e685-40ed-8a0d-0117cccf161d"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""Interact"",
            ""id"": ""5335ea78-0a00-4ec3-b1ce-856679346a80"",
            ""actions"": [
                {
                    ""name"": ""TriggerObject"",
                    ""type"": ""Button"",
                    ""id"": ""617b08e0-6a0e-499d-b08c-384aaf7c8e01"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c7d897e5-a24c-44b0-8887-24ea142e4110"",
                    ""path"": ""<Keyboard>/f"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""TriggerObject"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        // Torch
        m_Torch = asset.FindActionMap("Torch", throwIfNotFound: true);
        m_Torch_Toggle = m_Torch.FindAction("Toggle", throwIfNotFound: true);
        m_Torch_Dim = m_Torch.FindAction("Dim", throwIfNotFound: true);
        m_Torch_Normal = m_Torch.FindAction("Normal", throwIfNotFound: true);
        // Interact
        m_Interact = asset.FindActionMap("Interact", throwIfNotFound: true);
        m_Interact_TriggerObject = m_Interact.FindAction("TriggerObject", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Torch.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Torch.Disable() has not been called.");
    ...
    // Torch
    private readonly InputActionMap m_Torch;
    private List<ITorchActions> m_TorchActionsCallbackInterfaces = new List<ITorchActions>();
    private readonly InputAction m_Torch_Toggle;
    private readonly InputAction m_Torch_Dim;
    private readonly InputAction m_Torch_Normal;
    /// <summary>
    /// Provides access to input actions defined in input action map "Torch".
    /// </summary>
    public struct TorchActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TorchActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Torch/Toggle".
        /// </summary>
        public InputAction @Toggle => m_Wrapper.m_Torch_Toggle;
        /// <summary>
        /// Provides access to the underlying input action "Torch/Dim".
        /// </summary>
        public InputAction @Dim => m_Wrapper.m_Torch_Dim;
        /// <summary>
        /// Provides access to the underlying input action "Torch/Normal".
        /// </summary>
        public InputAction @Normal => m_Wrapper.m_Torch_Normal;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Torch; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="TorchActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(TorchActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="TorchActions" />
        public void AddCallbacks(ITorchActions instance)
        {
            if (instance == null || m_Wrapper.m_TorchActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TorchActionsCallbackInterfaces.Add(instance);
            @Toggle.started += instance.OnToggle;
            @Toggle.performed += instance.OnToggle;
            @Toggle.canceled += instance.OnToggle;
            @Dim.started += instance.OnDim;
            @Dim.performed += instance.OnDim;
            @Dim.canceled += instance.OnDim;
        ...
        /// </remarks>
        /// <seealso cref="TorchActions" />
        private void UnregisterCallbacks(ITorchActions instance)
        {
            @Toggle.started -= instance.OnToggle;
            @Toggle.performed -= instance.OnToggle;
            @Toggle.canceled -= instance.OnToggle;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="TorchActions.UnregisterCallbacks(ITorchActions)" />.
        /// </summary>
        /// <seealso cref="TorchActions.UnregisterCallbacks(ITorchActions)" />
        public void RemoveCallbacks(ITorchActions instance)
        {
            if (m_Wrapper.m_TorchActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="TorchActions.AddCallbacks(ITorchActions)" />
        /// <seealso cref="TorchActions.RemoveCallbacks(ITorchActions)" />
        /// <seealso cref="TorchActions.UnregisterCallbacks(ITorchActions)" />
        public void SetCallbacks(ITorchActions instance)
        {
            foreach (var item in m_Wrapper.m_TorchActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TorchActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="TorchActions" /> instance referencing this action map.
    /// </summary>
    public TorchActions @Torch => new TorchActions(this);

    // Interact
    private readonly InputActionMap m_Interact;
    private List<IInteractActions> m_InteractActionsCallbackInterfaces = new List<IInteractActions>();
    private readonly InputAction m_Interact_TriggerObject;
    /// <summary>
    ...
    public struct InteractActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Interact/TriggerObject".
        /// </summary>
        public InputAction @TriggerObject => m_Wrapper.m_Interact_TriggerObject;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public void AddCallbacks(IInteractActions instance)
        {
            ...
            @TriggerObject.started += instance.OnTriggerObject;
            @TriggerObject.performed += instance.OnTriggerObject;
            @TriggerObject.canceled += instance.OnTriggerObject;
        }
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Torch" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="TorchActions.AddCallbacks(ITorchActions)" />
    /// <seealso cref="TorchActions.RemoveCallbacks(ITorchActions)" />
    public interface ITorchActions
    {
        /// <summary>
        ...
        /// <summary>
        /// Method invoked when associated input action "Dim" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnDim(InputAction.CallbackContext context);
        /// <summary>
    ...
    {
        /// <summary>
        /// Method invoked when associated input action "TriggerObject" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnTriggerObject(InputAction.CallbackContext context);
    }
}
